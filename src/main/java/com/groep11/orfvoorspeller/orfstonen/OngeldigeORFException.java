...
/**
 * Exception class die wordt aangeroepen als een ORF een strand mist of een
 * ongeldig karakter als strand heeft gekregen.
 *
 * @author Koen
 */
public class OngeldigeORFException extends Exception {
